...
$(function() {
    ...
    $('#btn-setName').click(function() {
        ...
        if (checkUser(name)) {
            ...
            var imgList = ["/images/chat/1.jpg", "/images/chat/2.jpg", "/images/chat/3.jpg", "/images/chat/4.jpg", "/images/chat/5.jpg"];
...
function addImgFromUser(msgObj, isSelf) {
    ...
    var msgHtml = $('<div><div class="message-info"><div class="user-info"><img src="/images/chat/1.jpg" class="user-avatar img-thumbnail"></div><div class="message-content-box"><div class="arrow"></div><div class="message-content">test</div></div></div></div>');
