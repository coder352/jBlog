// 注释掉的那些都是从 N-blog 那个项目中引入的, 太大了, 就砍掉了...
...
var blog_signin = require('./routes/blog/signin')
var blog_signout = require('./routes/blog/signout')
var blog_signup = require('./routes/blog/signup')
...
app.use('/node_modules', express.static(__dirname + '/node_modules'));  // href='/bower_components/messenger/build/css/messenger.css' // 要这样用
...
// }));
// app.locals.blog = {  // 设置模板全局常量, 这样就不用每次都从路由中传了
//     title: pkg.name,
...
app.use('/blog', blog)
app.use('/blog/posts', blog_posts)
app.use('/blog/signin', blog_signin)
app.use('/blog/signout', blog_signout)
app.use('/blog/signup', blog_signup)
...
// My code: 404 page, 慎用, 调试的时候需要知道信息
